          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit}>
              <div className="space-y-4">
                <div>
                  <label htmlFor="name" className="block text-sm font-medium text-foreground sr-only">Your Name</label>
                  <Input
                    type="text"
                    id="name"
                    name="name"
                ...
                <div>
                  <label htmlFor="email" className="block text-sm font-medium text-foreground sr-only">Your Email</label>
                  <Input
                    type="email"
                    id="email"
                    name="email"
                ...
                <div>
                  <label htmlFor="message" className="block text-sm font-medium text-foreground sr-only">Your Message</label>
                  <Textarea
                    id="message"
                    name="message"
