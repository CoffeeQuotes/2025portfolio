      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="https://github.com/yourgithub" target="_blank" rel="noopener noreferrer" className="hover:text-[#E53E3E]">
              <Github size={24} />
            </a>
            ...
            <a href="mailto:your.email@example.com" className="hover:text-[#E53E3E]">
              <Mail size={24} />
            </a>
          </div>
        </div>
